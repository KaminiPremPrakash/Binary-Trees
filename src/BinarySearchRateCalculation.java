 ...
 */
class BinarySearchRateCalculation {
    ...
    public static void main(String[] args) {
        ...
        BinarySearchRateCalculation bTree = new BinarySearchRateCalculation();
        ...
        System.out.println("Heights generated for different values of K : ");
        for (int i = 0; i < heights.size(); i++) {
            System.out.print(heights.get(i) + ", ");
        }
        System.out.println("\n");
        System.out.println("Different values of K : ");
        for (int i = 0; i < kValues.size(); i++) {
            System.out.print(kValues.get(i) + ", ");
        }

        System.out.print("\n");
        System.out.print("\n");
        System.out.println("Calculating the rate of change of heights : ");
        //int heightDiff = 0;
        //int kDiff = 0;
        System.out.print("Rate of change of heights are : ");
        for (int i = 0; i < heights.size() - 1; i++) {
            double kDiff = kValues.get(i + 1) - kValues.get(i);
            double hDiff = heights.get(i + 1) - heights.get(i);
            double rate = hDiff / kDiff;
            System.out.print(Math.abs(rate) + ", ");
        }
    }
}
